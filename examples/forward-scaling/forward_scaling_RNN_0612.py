...
# For MNIST data, we will use this later
###########################################
...
# Serial version (provided two serial versions)
###########################################
if run_serial:
...
###########################################
  ...
  # In this case, the weights of basic_blocks in every processor are randomly initialied with the same values
  ###########################################
  ...
  # preprocess input data and distribute those to different processors
  ###########################################
  ...
  max_levels = 1 # set max_levels as 1 for testing parallel rnn purpose
  max_iters = 1 # set max_iters as 1 for testing parallel rnn purpose
